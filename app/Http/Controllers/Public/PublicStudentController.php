...
class PublicStudentController extends Controller
{
    ...
    {
        // Registration ID lives on the User. account now, not a
        // students.student_id string column (that column no longer exists).
        $user = \App\Models\User::where('registration_id', $id)->firstOrFail();
