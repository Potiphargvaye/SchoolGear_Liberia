        ...
        <div class="w-full max-w-2xl bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="p-8"
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <label class="file-upload flex-1">
                            ...
                            <div
                                class="file-upload-label border-2 border-dashed border-gray-300 rounded-lg p-4 text-center cursor-pointer hover:border-blue-400 transition-colors">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Registration ID -->
                    <div>
                        <label for="registration_id" class="block text-sm font-medium text-gray-700 mb-1">Registration ID
                            *</label>
                        <input type="text" id="registration_id" name="registration_id"
                            value="{{ old('registration_id') }}" required
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                            placeholder="EMBHS0001/2025">
                ...
                <div class="mt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                    <button type="button" id="cancelButton"
                        class="flex items-center gap-2 bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-600 transition-colors">
                    ...
                    <button type="submit"
                        class="flex items-center gap-2 bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
